private ["_characterID","_playerObj","_playerID","_dummy","_worldspace","_state","_doLoop","_key","_primary","_medical","_stats","_humanity","_lastinstance","_friendlies","_randomSpot","_position","_debugZone","_distance","_hit","_fractures","_score","_findSpot","_pos","_isIsland","_w","_clientID","_spawnMC","_namespace"];
...
_playerObj addEventHandler ["Hit", {_this spawn fnc_plyrHit;}];
...
/*	
	...
	//[false,false,false,false,false,false,false,12000,[],[0,0],0,[114.9,42.753]] // Medical Condition
...
*/
	_primary = call compile format ["%1",secondaryPre];
...
if (count _worldspace > 0) then {
	...
	_debugZone = getMarkerpos "respawn_west";
	_distance = _debugZone distance _position;
...
dayzPlayerLogin2 = [_worldspace,_state]; // Sandbird
