if (!isDedicated) then {
	...
	sdbd_fnc_setup =   			compile preprocessFileLineNumbers "dayz_code\init\sandbird_server_playerSetup.sqf";
	sdbd_fnc_login =				compile preprocessFileLineNumbers "dayz_code\init\sandbird_server_playerLogin.sqf";
