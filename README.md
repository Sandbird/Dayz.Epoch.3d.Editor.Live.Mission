...
An mission file for the purpose of testing scripts for [DayZ Epoch](https://github.com/vbawol/DayZ-Epoch) without the need of a server.
...
And on a personal note....You will NEVER find a better way to code stuff for Dayz. 
